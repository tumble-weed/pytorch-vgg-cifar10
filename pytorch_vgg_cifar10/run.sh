...
#do
model=vgg16_bn
echo "python main.py  --arch=$model --epochs 2 --save-dir=save_$model |& tee -a log_$modeli"
python main.py  --arch=$model --epochs 2 --save-dir=save_$model |& tee -a log_$model
#done
